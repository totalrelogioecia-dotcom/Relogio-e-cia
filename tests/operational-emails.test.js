...
test('varredura histórica pode ignorar pedidos de teste anteriores ao corte', () => {
  ...
  process.env.OPERATIONAL_EMAILS_SINCE = '2026-09-21T00:00:00-03:00';
  ...
  try {
    ...
    assert.equal(eligibleHistoricalOrder({ created_at: '2026-09-20T23:59:59-03:00' }), false);
    assert.equal(eligibleHistoricalOrder({ created_at: '2026-09-21T00:00:00-03:00' }), true);
