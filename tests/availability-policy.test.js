...
test('Casio sob encomenda pode ser comprado sem estoque físico', () => {
...
test('pedido mediante confirmação não pode seguir para pagamento', () => {
  const product = { id: 12, nome: 'Casio Limitado', marca: 'Casio', estoque: 0 };
...
test('marcas fora de Casio e G-Shock continuam usando estoque físico', () => {
  const product = { id: 13, nome: 'Outra marca', marca: 'Orient', estoque: 0 };
