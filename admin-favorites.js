(() => {
  ...
  function injectHubStyles(){if(document.getElementById('admin-hub-style'))return;const s=document.createElement('style');s.id='admin-hub-style';s.textContent=`
    ...
    html.reloja-dark .admin-hub-card,html.reloja-dark .admin-back-hub{background:var(--bg-soft)!important;color:var(--ink)!important;border-color:var(--line-strong)!important}html.reloja-high-contrast .admin-hub-card,html.reloja-high-contrast .admin-back-hub{background:#fff!important;color:#000!important;border:2px solid #000!important}
