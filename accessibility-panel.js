(() => {
  ...
  function styles(){
    ...
    const s=document.createElement('style');s.id='reloja-accessibility-panel-style';s.textContent=`
      ...
      .reloja-a11y-group{border:0;padding:0;margin:18px 0}.reloja-a11y-group legend{font-family:var(--font-mono,monospace);font-size:.76rem;letter-spacing:.08em;text-transform:uppercase;font-weight:700;margin-bottom:9px}.reloja-a11y-row{display:flex;align-items:center;justify-content:space-between;gap:16px;padding:11px 0;border-bottom:1px solid var(--line,#ddd)}.reloja-a11y-row.reloja-a11y-row-icon{display:grid;grid-template-columns:28px minmax(0,1fr) auto;gap:12px}.reloja-a11y-row:last-child{border-bottom:0}.reloja-a11y-copy{font-size:.88rem;line-height:1.4}.reloja-a11y-row small{display:block;color:var(--ink-soft,#666);font-size:.72rem;margin-top:2px}.reloja-a11y-icon{width:24px;height:24px;display:grid;place-items:center;color:var(--ink,#111)}.reloja-a11y-icon svg{width:24px;height:24px;display:block;overflow:visible}.reloja-a11y-icon .a11y-accent{stroke:#4cc9f0;fill:none}.reloja-a11y-row input[type=checkbox]{width:22px;height:22px;flex:0 0 auto}.reloja-a11y-row select{min-width:120px;padding:8px;border:1px solid currentColor;border-radius:0;background:var(--bg,#fff);color:inherit;font:inherit}.reloja-a11y-reset{width:100%;min-height:44px;border:1px solid currentColor;border-radius:0;background:transparent;color:inherit;font-family:var(--font-mono,monospace);font-weight:700;cursor:pointer}.reloja-a11y-status{position:absolute;left:-9999px}.reloja-skip-link{position:fixed;left:12px;top:12px;z-index:700;transform:translateY(-150%);background:#000;color:#fff;padding:12px 16px;font-weight:700;text-decoration:none}.reloja-skip-link:focus{transform:none}
  ...
  function install(){
    ...
    const backdrop=document.createElement('div');backdrop.className='reloja-a11y-backdrop';backdrop.setAttribute('aria-hidden','true');backdrop.innerHTML=`<section id="reloja-a11y-panel" class="reloja-a11y-panel" role="dialog" aria-modal="true" aria-labelledby="reloja-a11y-title"><div class="reloja-a11y-head"><div><h2 id="reloja-a11y-title">Acessibilidade</h2><p>Todos os ajustes ficam reunidos aqui e salvos neste navegador.</p></div><button class="reloja-a11y-close" type="button" aria-label="Fechar painel">×</button></div><fieldset class="reloja-a11y-group"><legend>Visualização</legend><label class="reloja-a11y-row reloja-a11y-row-icon"><span class="reloja-a11y-icon" aria-hidden="true" data-a11y-icon="contrast"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="8"></circle><path class="a11y-accent" d="M12 4a8 8 0 0 1 0 16V4Z"></path></svg></span><span class="reloja-a11y-copy">Alto contraste<small>Preto e branco com contornos reforçados.</small></span><input name="contrast" type="checkbox"></label><label class="reloja-a11y-row reloja-a11y-row-icon"><span class="reloja-a11y-icon" aria-hidden="true" data-a11y-icon="dark"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M18 14.5A6.5 6.5 0 0 1 9.5 6 7 7 0 1 0 18 14.5Z"></path><path class="a11y-accent" d="M17.7 5.2h.1M20 8h.1"></path></svg></span><span class="reloja-a11y-copy">Modo escuro<small>Reduz a luminosidade da interface.</small></span><input name="dark" type="checkbox"></label><label class="reloja-a11y-row reloja-a11y-row-icon"><span class="reloja-a11y-icon" aria-hidden="true" data-a11y-icon="scale"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M4 18 8 7l4 11M5.5 14h5"></path><path class="a11y-accent" d="M18 6v12M15.5 8.5 18 6l2.5 2.5M15.5 15.5 18 18l2.5-2.5"></path></svg></span><span class="reloja-a11y-copy">Tamanho do texto<small>Amplia o texto sem usar o zoom do navegador.</small></span><select name="scale"><option value="100">100%</option><option value="110">110%</option><option value="120">120%</option><option value="130">130%</option><option value="140">140%</option></select></label><label class="reloja-a11y-row reloja-a11y-row-icon"><span class="reloja-a11y-icon" aria-hidden="true" data-a11y-icon="readable"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M3.5 18 7 8l3.5 10M4.8 14h4.4M14 18v-7M14 13.5c0-1.6 1.1-2.6 2.7-2.6 1.7 0 2.8 1 2.8 2.6V18"></path><path class="a11y-accent" d="M13.8 7h5.7"></path></svg></span><span class="reloja-a11y-copy">Fonte de alta legibilidade<small>Usa uma família sem serifa mais simples.</small></span><input name="readable" type="checkbox"></label><label class="reloja-a11y-row reloja-a11y-row-icon"><span class="reloja-a11y-icon" aria-hidden="true" data-a11y-icon="spacing"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M4 12h16M7 9l-3 3 3 3M17 9l3 3-3 3"></path><path class="a11y-accent" d="M9.5 7.5v9M14.5 7.5v9"></path></svg></span><span class="reloja-a11y-copy">Mais espaçamento<small>Aumenta linhas, letras e palavras.</small></span><input name="spacing" type="checkbox"></label><label class="reloja-a11y-row reloja-a11y-row-icon"><span class="reloja-a11y-icon" aria-hidden="true" data-a11y-icon="links"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M10 14 8 16a3 3 0 0 1-4-4l3-3a3 3 0 0 1 4 0M14 10l2-2a3 3 0 1 1 4 4l-3 3a3 3 0 0 1-4 0"></path><path class="a11y-accent" d="M8 20h8"></path></svg></span><span class="reloja-a11y-copy">Sublinhar links<small>Facilita identificar elementos clicáveis.</small></span><input name="links" type="checkbox"></label></fieldset><fieldset class="reloja-a11y-group"><legend>Navegação e movimento</legend><label class="reloja-a11y-row"><span>Reduzir animações<small>Minimiza movimentos e transições.</small></span><input name="motion" type="checkbox"></label><label class="reloja-a11y-row"><span>Foco reforçado<small>Destaca o elemento selecionado pelo teclado.</small></span><input name="focus" type="checkbox"></label><label class="reloja-a11y-row"><span>Botões e campos maiores<small>Aumenta alvos de clique e toque.</small></span><input name="targets" type="checkbox"></label><label class="reloja-a11y-row"><span>Guia de leitura<small>Exibe uma faixa horizontal acompanhando ponteiro ou foco.</small></span><input name="guide" type="checkbox"></label></fieldset><button class="reloja-a11y-reset" type="button">Restaurar padrão</button><div class="reloja-a11y-status" aria-live="polite"></div></section>`;document.body.appendChild(backdrop);panel=backdrop.querySelector('.reloja-a11y-panel');status=panel.querySelector('.reloja-a11y-status');
