(() => {
  ...
  function installTrigger(){
    ...
    b.innerHTML='<svg class="reloja-a11y-symbol" viewBox="0 0 24 24" aria-hidden="true" focusable="false"><circle cx="12" cy="4" r="2.1"></circle><path d="M5 8.5h14"></path><path d="M12 6.5v7"></path><path d="M12 13.5 7.5 21"></path><path d="M12 13.5 16.5 21"></path></svg><span class="reloja-visually-hidden">Acessibilidade</span>';
