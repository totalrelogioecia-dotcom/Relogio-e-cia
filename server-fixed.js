...
app.post('/api/mercadopago/webhook', async (req, res) => {
  ...
  // O botão "Simular notificação" do Mercado Pago envia o Data ID no corpo.
  // Ele pode não enviar data.id na query string, que é necessária para HMAC.
  // Nesse caso, apenas confirmamos o recebimento; não alteramos pedido/estoque.
  ...
  // Confirmamos rapidamente para evitar reenvios desnecessários.
  res.sendStatus(200);
